...
void Tilemap::Draw() {
    ...
    if (GetCurrentMode() == DrawModes::TEXTURE_LIGHT) {
        GetShader(DrawModes::TEXTURE_LIGHT).SetMatrix4fv("transform", transform);
        GetShader(DrawModes::TEXTURE_LIGHT).SetVector3f("offset",
                                       glm::vec3(glm::vec2(0, 0), 0.0f));
        GetShader(DrawModes::TEXTURE_LIGHT).SetColor("inputColor", WHITE);
    } else {
        GetShader(DrawModes::TEXTURE).SetMatrix4fv("transform", transform);
        GetShader(DrawModes::TEXTURE).SetVector3f("offset", glm::vec3(glm::vec2(0, 0), 0.0f));
        GetShader(DrawModes::TEXTURE).SetColor("inputColor", WHITE);
    }
