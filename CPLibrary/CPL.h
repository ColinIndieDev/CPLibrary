...
void DrawTriangleRotated(glm::vec2 position, glm::vec2 size, float angle,
                         const Color &color);
void DrawTriangleOutline(glm::vec2 position, glm::vec2 size,
                         const Color &color);
void DrawTriangleRotOut(glm::vec2 position, glm::vec2 size, float angle,
                        const Color &color);
void DrawRectangle(glm::vec2 position, glm::vec2 size, const Color &color);
void DrawRectangleRotated(glm::vec2 position, glm::vec2 size, float angle,
                          const Color &color);
void DrawRectangleOutline(glm::vec2 position, glm::vec2 size,
                          const Color &color);
void DrawRectangleRotOut(glm::vec2 position, glm::vec2 size, float angle,
                         const Color &color);
...
void DrawText(glm::vec2 position, float scale, const std::string &text,
              const Color &color);
void DrawTextShadow(glm::vec2 position, glm::vec2 shadowOffset, float scale,
...
inline void EndDrawing() { glUseProgram(0); }

inline void framebuffer_size_callback(GLFWwindow *window, const int width,
                                      const int height) {
...
inline bool IsKeyDown(const int key) { return keyStates[key]; }
inline bool IsKeyUp(const int key) { return !keyStates[key]; }
...
inline bool IsMouseDown(const int button) { return mouseButtons[button]; }
